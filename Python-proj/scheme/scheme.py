...
def eval_all(expressions, env):
    ...
    if expressions is nil:
        return None
    elif expressions.second and expressions.second is not nil:
...
def do_and_form(expressions, env):     #!#
    ...
    if expressions is nil:
        return True
    elif expressions.second is nil or scheme_falsep(scheme_eval(expressions.first, env)):
        return scheme_eval(expressions.first, env, True)
    else:
...
def do_or_form(expressions, env):    #!#
    ...
    if expressions is nil:
        return False
    elif expressions.second is nil or scheme_truep(scheme_eval(expressions.first, env)):
        return scheme_eval(expressions.first, env, True)
    else:
