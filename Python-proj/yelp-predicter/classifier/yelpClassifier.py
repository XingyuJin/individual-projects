...
class YelpClassifier(object):
    ...
    def calculate_num_reviews_and_words_per_num_stars(self, train_rdd):
        ...
        num_reviews_words_per_num_stars = train_rdd.map(self.review_to_num_stars_num_words) \
    ...
    def classify_reviews(self, test_rdd):
        ...
        # Transformations:
        # 1. (review_id, num_stars, review_text_as_string) --> [((num_stars1, review_id), word1), ((num_stars1, review_id), word2), ((num_stars2, review_id), word1)...]f
    ...
    def review_to_word_counts(review):
        ...
        all_word = review[2].split(" ") #put all word in a list
        return [((review[1], word), 1) for word in all_word]
    ...
    def counts_to_probabilities(self, num_stars_and_word_counts):
        ...
        word_count = num_stars_and_word_counts[1]

        return (num_stars, {word:self.compute_likelihood(word_count, int(num_stars))})
    ...
    def review_to_num_stars_num_words(review):
        ...
        all_word = review[2].split(" ") #put all word in a list
        return (review[1], (1, len(all_word)))
    ...
    def add_review_and_word_counts(count1, count2):
        ...
        #return (count1[0], (num_reviews_of_num_stars, num_words_total_of_num_stars))
    ...
    def find_max_posterior(num_stars_posterior1, num_stars_posterior2):
        ...
        if (log_posterior1 > log_posterior2):
        	return (num_stars_posterior1[0], log_posterior1)
        else:
        	return (num_stars_posterior2[0], log_posterior2)
